# clone the repo to window host instead, this script is deprecated
#
# NOTE 
...
New-Item -ItemType Symboliclink -Force `
    -Path $PROFILE `
    -Target "\\wsl.localhost\ArchWSL\home\$Env:USERNAME\.config\poshrc\__init__.ps1"
...
New-Item -ItemType Symboliclink -Force `
    ...
    -Target "\\wsl.localhost\ArchWSL\home\$Env:USERNAME\.config\poshrc\"
